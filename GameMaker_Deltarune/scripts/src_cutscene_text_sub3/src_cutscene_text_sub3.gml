function cutscene_text_sub3(_txt, _face = noone, _text_end = true) {
	
	function cutscene_alt_text_sub3(_txt, _face = noone) {
	...
	array_push(cutscene, [cutscene_alt_text_sub3, [_txt, _face]])
	if _text_end
