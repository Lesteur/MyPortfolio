...
void setup()
{
  ...
  if(!myKinect.start(PKinect.XYZ|PKinect.COLOR|PKinect.UV|PKinect.PLAYER_INDEX|PKinect.SKELETON))
  {
...
{   
  ...
  map.setPlayerIndex(myKinect.getDepthFrame(),myKinect.getPlayerIndex());
  map.maskPlayers();
