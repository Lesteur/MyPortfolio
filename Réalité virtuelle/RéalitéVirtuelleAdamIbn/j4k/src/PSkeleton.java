...
public class PSkeleton extends Skeleton{
	...
	public static PSkeleton getPSkeleton(int id, boolean[] flags,  float[] positions, float[] orientations, byte[] states,PKinect kinect)
	{
		if(id<0 || id>=6 || positions==null) return null;
		
		Skeleton s=Skeleton.getSkeleton(id, flags, positions, orientations, states, kinect);
		
		PSkeleton sk=new PSkeleton();
		sk.setPlayerID(id);
		if(flags!=null)sk.setIsTracked(flags[id]);
		sk.setJointPositions(s.getJointPositions());
		sk.setJointOrientations(s.getJointOrientations());
		sk.setJointTrackingStates(s.getJointTrackingStates());
		return sk;
	}
	...
	public void draw()
	{
		...
		if(skeleton_tracked)
		{	
			//1 MAIN BODY: SPINE_BASE, SPINE_MID, NECK, HEAD
			g.beginShape(PConstants.LINES);
		
			g.vertex(-get3DJointX(SPINE_BASE),get3DJointY(SPINE_BASE),-get3DJointZ(SPINE_BASE));
			g.vertex(-get3DJointX(SPINE_MID),get3DJointY(SPINE_MID),-get3DJointZ(SPINE_MID));
			
			g.vertex(-get3DJointX(SPINE_MID),get3DJointY(SPINE_MID),-get3DJointZ(SPINE_MID));
			g.vertex(-get3DJointX(NECK),get3DJointY(NECK),-get3DJointZ(NECK));
			
			g.vertex(-get3DJointX(NECK),get3DJointY(NECK),-get3DJointZ(NECK));
			g.vertex(-get3DJointX(HEAD),get3DJointY(HEAD),-get3DJointZ(HEAD));
			
			//2 LEFT ARM: NECK, SHOULDER_LEFT, ELBOW_LEFT, WRIST_LEFT, HAND_LEFT
			g.vertex(-get3DJointX(NECK),get3DJointY(NECK),-get3DJointZ(NECK));
			...
			//3 RIGHT ARM: NECK, SHOULDER_RIGHT, ELBOW_RIGHT, WRIST_RIGHT, HAND_RIGHT
			g.vertex(-get3DJointX(NECK),get3DJointY(NECK),-get3DJointZ(NECK));
			...
			//4 LEFT LEG: SPINE_BASE, HIP_LEFT, KNEE_LEFT, ANKLE_LEFT, FOOT_LEFT
			g.vertex(-get3DJointX(SPINE_BASE),get3DJointY(SPINE_BASE),-get3DJointZ(SPINE_BASE));
			...
			//5 RIGHT LEG: SPINE_BASE, HIP_RIGHT, KNEE_RIGHT, ANKLE_RIGHT, FOOT_RIGHT
			g.vertex(-get3DJointX(SPINE_BASE),get3DJointY(SPINE_BASE),-get3DJointZ(SPINE_BASE));
	...
	public void draw2D()
	{
		...
		{
	    //1 MAIN BODY
	    g.line(get2DJointX(SPINE_BASE),get2DJointY(SPINE_BASE),get2DJointX(SPINE_MID),get2DJointY(SPINE_MID));
	    g.line(get2DJointX(SPINE_MID),get2DJointY(SPINE_MID),get2DJointX(NECK),get2DJointY(NECK));
	    g.line(get2DJointX(NECK),get2DJointY(NECK),get2DJointX(HEAD),get2DJointY(HEAD));
	    //2 LEFT ARM
	    g.line(get2DJointX(NECK),get2DJointY(NECK),get2DJointX(SHOULDER_LEFT),get2DJointY(SHOULDER_LEFT));
	    ...
	    //3 RIGHT ARM
	    g.line(get2DJointX(NECK),get2DJointY(NECK),get2DJointX(SHOULDER_RIGHT),get2DJointY(SHOULDER_RIGHT));
	    ...
	    //4 LEFT LEG
	    g.line(get2DJointX(SPINE_BASE),get2DJointY(SPINE_BASE),get2DJointX(HIP_LEFT),get2DJointY(HIP_LEFT));
	    ...
	    //5 RIGHT LEG
	    g.line(get2DJointX(SPINE_BASE),get2DJointY(SPINE_BASE),get2DJointX(HIP_RIGHT),get2DJointY(HIP_RIGHT));
