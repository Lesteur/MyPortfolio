function cutscene_text_sub1(_txt, _face = noone, _text_end = true) {
	
	// Function
	function cutscene_alt_text_sub1(_txt, _face = noone) {
	...
	array_push(cutscene, [cutscene_alt_text_sub1, [_txt, _face]])
	if _text_end
